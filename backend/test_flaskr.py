...
class BookTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format(
            "postgres", "presidenT98!", "localhost:5432", self.database_name
        )
...
# Optional: Update the book information in setUp to make the test database your own!
    def test_get_paginated_book(self):
        ...
        self.assertTrue(data['total_books']) # Check if this returns a number
    ...
    def test_400_failed_book_update(self):
    ...
    #     res = self.client().get('/books/16')
    #     data = jsons.loads(res.data)
